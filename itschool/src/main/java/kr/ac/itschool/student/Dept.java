...
public class Dept implements ActionListener {
	JFrame frame;
	JFrame framedept = new JFrame("학과등록");
	...
	public void actionPerformed(ActionEvent e) {
		...
		framedept.setLocation(300,300);
		framedept.setPreferredSize(new Dimension(950, 300));
		framedept.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		ActionListener homelistener = new HomeButton();
		
		Container contentPane = framedept.getContentPane();
		
		Font font = new Font("바탕체", Font.TYPE1_FONT, 20);
		Font font1 = new Font("고딕체", Font.TYPE1_FONT, 15);
		String colName[] = { "코드","학과명" };
		...
		JLabel labelname = new JLabel( "학 과 명" );
		...
		ActionListener listner = new deptActionListener(model, table, code, name, find);
		MouseListener mouse = new deptActionListener(model, table, code, name, find);
